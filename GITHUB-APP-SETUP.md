...
| **Callback URL** | `https://app.codesheriff.dev/api/github/callback` |
| **Setup URL** (optional) | `https://app.codesheriff.dev/onboarding` |
| **Webhook URL** | `https://api.codesheriff.dev/webhooks/github` |
